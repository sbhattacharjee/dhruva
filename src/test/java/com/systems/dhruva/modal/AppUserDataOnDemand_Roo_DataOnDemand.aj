...
import com.systems.dhruva.modal.AppUserDataOnDemand;
...
privileged aspect AppUserDataOnDemand_Roo_DataOnDemand {
    ...
    public void AppUserDataOnDemand.setDept(AppUser obj, int index) {
        String dept = "dept_" + index;
        obj.setDept(dept);
    }
    
    public void AppUserDataOnDemand.setEmailId(AppUser obj, int index) {
        String emailId = "foo" + index + "@bar.com";
        obj.setEmailId(emailId);
    }
    
    public void AppUserDataOnDemand.setEmpId(AppUser obj, int index) {
        String empId = "empId_" + index;
        obj.setEmpId(empId);
    }
    
    public void AppUserDataOnDemand.setFirstName(AppUser obj, int index) {
